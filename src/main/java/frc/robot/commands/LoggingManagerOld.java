...
public class LoggingManagerOld extends Command {
     ...
     */
    public LoggingManagerOld(SwerveSubsystem swerveSub, VisionSubsystem reefSub, VisionSubsystem funnelSub, ElevSubsystem elevSub, ClimbSubsystem climbSub) {
        swerve = swerveSub;
        reef = reefSub;
        funnel = funnelSub;
        elev = elevSub;
