    ...
    */
    ...
    public void periodic()
    {
        ...
        if(getCurrentCommand() == null)
            LoggingManager.logAndAutoSendValue("Swerve RunningCommand", "None");
        else
            LoggingManager.logAndAutoSendValue("Swerve RunningCommand", getCurrentCommand().getName());
        
        LoggingManager.logValue("SwervePose", Pose2d.struct, getPose(), true);
